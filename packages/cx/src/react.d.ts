...
declare namespace React {
  ...
  type ElementType<P = any> =
    | {
        [K in keyof JSXReact.IntrinsicElements]: P extends JSXReact.IntrinsicElements[K]
          ? K
          : never;
      }[keyof JSXReact.IntrinsicElements]
    | ComponentType<P>;
   ...
   * - JSXReact intrinsics like `div` will give you their DOM instance. For `React.ElementRef<'div'>` that would be
  ...
  interface ReactComponentElement<
    T extends keyof JSXReact.IntrinsicElements | JSXElementConstructor<any>,
  ...
  // However, we have no way of telling the JSXReact parser that it's a JSXReact element type or its props other than
  ...
  > = T extends JSXElementConstructor<infer P>
    ? P
    : T extends keyof JSXReact.IntrinsicElements
    ? JSXReact.IntrinsicElements[T]
    : {};
  ...
  // Keep in sync with JSXReact namespace in ./JSXReact-runtime.d.ts and ./JSXReact-dev-runtime.d.ts
  namespace JSXReact {
...
declare global {
  /**
   * @deprecated Use `React.JSXReact` instead of the global `JSXReact` namespace.
   */
  namespace JSXReact {
...
// React.JSXReact needs to point to global.JSXReact to keep global module augmentations intact.
// But we can't access global.JSXReact so we need to create these aliases instead.
// Once the global JSXReact namespace will be removed we replace React.JSXReact with the contents of global.JSXReact
type GlobalJSXElementType = JSXReact.ElementType;
interface GlobalJSXElement extends JSXReact.Element {}
interface GlobalJSXElementClass extends JSXReact.ElementClass {}
interface GlobalJSXElementAttributesProperty
  extends JSXReact.ElementAttributesProperty {}
interface GlobalJSXElementChildrenAttribute
  extends JSXReact.ElementChildrenAttribute {}

export type GlobalJSXLibraryManagedAttributes<C, P> =
  JSXReact.LibraryManagedAttributes<C, P>;

export interface GlobalJSXIntrinsicAttributes
  extends JSXReact.IntrinsicAttributes {}

export interface GlobalJSXIntrinsicClassAttributes<T>
  extends JSXReact.IntrinsicClassAttributes<T> {}

export interface GlobalJSXIntrinsicElements
  extends JSXReact.IntrinsicElements {}
